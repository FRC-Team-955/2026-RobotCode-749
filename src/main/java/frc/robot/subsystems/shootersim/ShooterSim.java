...
public class ShooterSim {
    ...
    public ShooterSim(){
        ...
        AngularVelocityToLandingPt.add(38,2.48); //107 in
        AngularVelocityToLandingPt.add(52,3.86); //meters!  160 in
        AngularVelocityToLandingPt.add(65,4.58); // THIS ISNT TUNED!
