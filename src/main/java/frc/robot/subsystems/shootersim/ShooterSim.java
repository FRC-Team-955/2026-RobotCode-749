...
public class ShooterSim {
    ...
    public ShooterSim(){
        ...
        AngularVelocityToLandingPt.add(37,2.48); //107 in
        AngularVelocityToLandingPt.add(50,3.86); //meters!  160 in
        AngularVelocityToLandingPt.add(63,4.58); // THIS ISNT TUNED!
...
return Poses;
    ...
    public double getShooterVel(Pose2d robotPose, double robot_vx, double robot_vy, ArrayList<Pose3d> target){
        ...
        for(double cV = 20; cV<100; cV+=0.95){ // THIS (Delta cV) CANT BE LOW OR IT LOOP OVERRUNS SINCE ROBORIOS ARE CRAPPY
